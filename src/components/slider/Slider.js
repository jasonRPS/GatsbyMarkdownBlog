...
const Slider = () => {
  return (
    <SliderCss>
      <div class="gallery">
        <div className="slide-container" id="slide-1">
        ...
        <div className="slide-container" id="slide-2">
        ...
        <div className="slide-container" id="slide-3">
        ...
        <div className="slide-container" id="slide-4">
        ...
        <div className="slide-container" id="slide-5">
      ...
      <div id="slider-nav">
        <a href="#slide-1">
          <div className="nav-elm">
            <p>Here is Slide 1 And something else if we need more</p>
          </div>
        </a>
        <a href="#slide-2">
          <div className="nav-elm">
